...
export default function ContactList() {
  ...
  if (contactsData.contextState.contacts.length !== 0) {
    ...
    return (
      <div className="px-10 py-20 flex-grow overflow-x-hidden flex justify-center items-center overflow-y-hidden desktop:overflow-y-scroll custom-scrollbar desktop:h-[560px] max-w-[960px] cursor-default">
        <div className="flex flex-col justify-center items-center border-2 pb-12 rounded-lg">
          <img
