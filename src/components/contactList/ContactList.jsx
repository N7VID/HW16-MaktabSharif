...
export default function ContactList() {
  ...
  if (contextState?.contacts?.length !== 0) {
    return (
      <div className="px-10 pt-8 pb-12 desktop:py-10 flex-grow grid grid-cols-1 gap-y-8 gap-x-6 desktop:grid-cols-3 tablet:grid-cols-2 desktop:h-[560px] max-w-[900px]">
